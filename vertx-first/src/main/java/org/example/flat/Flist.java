...
public final class Flist extends Table {
  ...
  public org.example.flat.Fmap datas(int j) { return datas(new org.example.flat.Fmap(), j); }
  public org.example.flat.Fmap datas(org.example.flat.Fmap obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int datasLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public org.example.flat.Fmap.Vector datasVector() { return datasVector(new org.example.flat.Fmap.Vector()); }
  public org.example.flat.Fmap.Vector datasVector(org.example.flat.Fmap.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
